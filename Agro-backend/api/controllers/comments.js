...
exports.comments_publish_comment = async (req, res, next) => {
  try {
    ...
    const comment = new Comment({
      ...
      authorProfilePicture: user?.profilePicture || null, // Store Google profile picture if available
    ...
    const response = createResponse("success", 0, "Comment stored", {
      ...
      authorProfilePicture: storedComment.authorProfilePicture,
  ...
  try {
    ...
    const response = createResponse("success", 0, "Reply stored", {
      reply: {
        ...
        authorProfilePicture: reply.authorProfilePicture,
      ...
      parentComment: {
        ...
        authorProfilePicture: updatedParentComment.authorProfilePicture,
