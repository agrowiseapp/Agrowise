...
const SubBottomScreen = ({ setopenSubBottomScreen }) => {
  ...
  // The user stays signed in. This used to delete "userToken" and bounce the
  // buyer to the Login screen straight after a successful payment.
