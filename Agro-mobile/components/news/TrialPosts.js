...
import TrialSelectedPost from "./singlePost/TrialSelectedPost";

const TrialPosts = ({ data, index, onCommentPosted, isDemoMode = false }) => {
  ...
  return (
    <>
      ...
      >
        {isDemoMode && (
          <View style={styles.demoWatermarkContainer}>
